...
function buildElement({ title, description, image_path, image, category, id, price, info, order }) {
    ...
    if (image) {
        style = `style="background-image: url('images/${path_base}/catalogo/${image_path}')"`
        heightImg = 'h-56';
    }
    ...
    let btnWhatsapp = `
        ...
        href="https://api.whatsapp.com/send?phone=34609570064&text=*Hola!*%0D%0AEstoy interesado en el Producto%3A%0D%0A*${title}*%0D%0A">
    ...
    if (info) {
        ...
        <button type="button" 
            ...
            <div class="flex">
                <img src="./images/${path_base}/images/cafe.png" class="h-5"/> 
